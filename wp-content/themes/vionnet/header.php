    		...
    		<?php zilla_header_start(); ?>
    			...
    			<div id="logo">
    				...
    				<?php } elseif( zilla_get_option('general_custom_logo') ) { ?>
    				    <a href="<?php echo home_url(); ?>" class="normalTip" title="Hernán Vionnet,<br>Ux Designer that kick ass"><img src="<?php echo zilla_get_option('general_custom_logo'); ?>" alt="Vionnet = NN"/></a>
    				<?php } else { ?>
                    ...
                    <h4><a title="title" href="/contact">Drop me a line</a></h4>
