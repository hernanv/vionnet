...
<?php /*?>				<h1 class="page-title"><?php printf(__('All posts in %s', 'zilla'), single_cat_title('',false)); ?></h1> <?php */?>  
              
			  <?php if (!is_category( 'testimonials' )) { ?>
                <h1 class="page-title"><?php printf( __('All entries in %s', 'zilla'), '<span>' . single_cat_title( '', false ) . '</span>' );?></h1>
              <?php };?>
                
	 	  	<?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
				<?php /*?><h1 class="page-title"><?php printf(__('All posts tagged %s', 'zilla'), single_tag_title('',false)); ?></h1><?php */?>
                <h1 class="page-title"><?php printf( __('All entries tagged %s', 'zilla'), '<span>' . single_tag_title( '', false ) . '</span>' );?></h1>
            ...
            <!-- BEGIN #primary .hfeed lo moví de lugar para que aparezca-->
			<div id="primary" class="hfeed isotope-container">
